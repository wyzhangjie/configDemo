...
import entity.search.SearchOperator;
import entity.search.Searchable;
import entity.search.exception.InvalidSearchPropertyException;
import entity.search.exception.InvalidSearchValueException;
import entity.search.exception.SearchException;
import entity.search.filter.AndCondition;
import entity.search.filter.Condition;
import entity.search.filter.OrCondition;
import entity.search.filter.SearchFilter;
