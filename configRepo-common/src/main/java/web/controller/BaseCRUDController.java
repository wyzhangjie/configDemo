...
import service.GenericSqlMapService;
import web.bind.annotation.PageableDefaults;
import web.controller.permission.PermissionList;
...
public abstract class BaseCRUDController<M extends FieldAccessVo, ID extends Serializable>
    ...
    protected GenericSqlMapService<M, ID> baseService;
     ...
     */
    @Autowired
    public void setBaseService(GenericSqlMapService<M, ID> baseService) {
