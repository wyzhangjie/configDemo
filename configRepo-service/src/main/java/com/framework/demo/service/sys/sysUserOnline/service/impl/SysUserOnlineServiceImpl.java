...
public class SysUserOnlineServiceImpl extends ExtendGenericSqlMapServiceImpl<SysUserOnline, String> implements SysUserOnlineService {

    @Autowired
    private SysUserOnlineMapper sysUserOnlineDao;

    public ExtendDaoMapper<SysUserOnline, String> getDao() {
