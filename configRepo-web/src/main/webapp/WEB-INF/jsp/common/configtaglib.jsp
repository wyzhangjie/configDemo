...
<script type="text/javascript" src="<%=basePath%>js/jqgrid/i18n/grid.locale-en.js"  ></script>
<script type="text/javascript" src="<%=basePath%>js/jqgrid/jquery.jqGrid.min.js"  ></script>
