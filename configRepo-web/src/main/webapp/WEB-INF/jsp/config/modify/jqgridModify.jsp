...
<title></title>
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/page/config/create/jqgridModify.css">
    <script type="text/javascript" src="<%=basePath%>js/page/config/modify/jqgridModify.js"></script>
