...
<title></title>
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/page/config/create/echartsModifyDate.css">
    <script type="text/javascript" src="<%=basePath%>js/page/config/modify/echartsModifyDate.js"></script>
...
<div id="modiMode1"  >
  <form action="${basePath }/config/hasPageTepMody" id="form1" class="easyui-form" method="post" >
    <div style="text-align: center;font-size: 25px;margin-left: 461px;margin-bottom: 30px;">多维度时间报表修改区域</div>
    <div id="cdpz">
  ...
  <select name="pmenuName0"  id="pmenuName0" data-options="required:true">
      ...
      <label >  修改菜单名称</label>  <span id="menuName"> <input class="easyui-textbox"  type="text" name="menuName0" id="menuName0" data-options="required:true"  ></span>
