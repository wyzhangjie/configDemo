...
<title></title>
    ...
    <script type="text/javascript" src="<%=basePath%>js/page/config/modify/modifyMixDate.js"></script>
    <link href="<%=basePath%>css/page/config/modify/mixModifyDate.css?p=9" type="text/css" rel="stylesheet" />
...
<div id="modiMode3"  >
    <form action="${basePath }/config/mix1Modify" id="form3" class="easyui-form" method="post" >
        <div style="text-align: center;font-size: 25px;margin-left: 490px;margin-top: 40px;margin-bottom:30px">双轴时间多维度报表修改区域</div>
...
     
        ...
        <div id="imptant">
            <div id="sql1" style="float: left;clear: both; ">
                ...
                <label id="left">请输入左侧坐标<br/>(带{start}和{end})</label>
            ...
            <div id="sql2"  >
                ...
                <label  id="right">请输入右侧坐标<br/>(带{start}和{end})</label>
