...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/page/config/create/configMixDemo.css?v=7"/>
    <script type="text/javascript" src="<%=basePath%>js/page/config/create/configMixDemo.js?v=1" charset="utf-8"></script>
...
<div id="title">双轴报表配置区域</div>
  ...
  <select name="kind">
    ...
    <div id="tu2data">
      ...
      <span>报表类型</span>
    <span id="mix1_report" style="height:25px;">
...
     
      ...
      <span style="display:none;" > 文件路径  </span>  <span id="file_path" style="display:none;">  <input  type="text" id="filePath"  style="display:none;" name="filePath" value="/jsp/config/mix1"> </span>
    </div>
    <div id="real_time">
