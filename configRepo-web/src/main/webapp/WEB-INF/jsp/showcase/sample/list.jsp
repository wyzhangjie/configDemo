...
<div data-table="table" class="panel">
    ...
    <ul class="nav nav-tabs">
        ...
        <li ${param['search.isShow_eq'] eq 'true' ? 'class="active"' : ''}>
            <a href="${ctx}/showcase/sample?search.isShow_eq=true">
                <i class="icon-table"></i>
                可显示的示例列表
            </a>
        </li>
        <li ${param['search.isShow_eq'] eq 'false' ? 'class="active"' : ''}>
            <a href="${ctx}/showcase/sample?search.isShow_eq=false">
                <i class="icon-table"></i>
                隐藏的示例列表
            </a>
        </li>
