...
w="eq";v>=0&&p[v].searchoptions&&p[v].searchoptions.sopt?w=p[v].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(w=b.sopt[0]),j={groupOp:"AND",rules:[{field:n,op:w,data:""}]}}u=!1,b.tmplNames&&b.tmplNames.length&&(u=!0,t=b.tmplLabel,t+="<select class='ui-mix1template'>",t+="<option value='default'>Default</option>",a.each(b.tmplNames,function(a,b){t+="<option value='"+a+"'>"+b+"</option>"}),t+="</select>"),o="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+f+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+l+"'>"+r+t+"</td><td class='EditButton' "+m+">"+s+q+"</td></tr></tbody></table>",f=a.jgrid.jqID(f),a("#"+f).jqFilter({columns:p,filter:b.loadDefaults?j:null,showQuery:b.showQuery,errorcheck:b.errorcheck,sopt:b.sopt,groupButton:b.multipleGroup,ruleButtons:b.multipleSearch,afterRedraw:b.afterRedraw,ops:b.odata,operands:b.operands,ajaxSelectOptions:d.p.ajaxSelectOptions,groupOps:b.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString()),a.isFunction(b.afterChange)&&b.afterChange.call(d,a("#"+f),b)},direction:d.p.direction,id:d.p.id}),k.append(o),u&&b.tmplFilters&&b.tmplFilters.length&&a(".ui-mix1template",k).bind("change",function(){var
...
c={},e=a("#"+f);return d.p.search=!1,d.p.resetsearch=!0,b.multipleSearch===!1?c[b.sField]=c[b.sValue]=c[b.sOper]="":c[b.sFilter]="",e[0].resetFilter(),u&&a(".ui-mix1template",k).val("default"),a.extend(d.p.postData,c),h=a(d).triggerHandler("jqGridFilterReset"),void
