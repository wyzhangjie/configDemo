 ...
 */
@Component("stackBarTemplate")
public class StackBarTemplate<T> extends BaseDataTemplate {
    Logger logger = LoggerFactory.getLogger(StackBarTemplate.class);
    @Override
